...
- (void)setAfterScrollShowView:(UIScrollView*)scrollview  andCurrentPage:(NSInteger)pageNumber
{
    ...
    oneLabel.textColor = [UIColor colorWithRed:75.0/255 green:75.0/255 blue:75.0/255 alpha:1];
 
    UILabel *twoLabel = (UILabel*)[[scrollview subviews] objectAtIndex:pageNumber+1];
    [twoLabel setFont:[UIFont systemFontOfSize:16]];
    twoLabel.textColor = [UIColor colorWithRed:75.0/255 green:75.0/255 blue:75.0/255 alpha:1];
    ...
    threeLabel.textColor =[UIColor colorWithRed:75.0/255 green:75.0/255 blue:75.0/255 alpha:1];

    UILabel *fourLabel = (UILabel*)[[scrollview subviews] objectAtIndex:pageNumber+4];
    [fourLabel setFont:[UIFont systemFontOfSize:14]];
    fourLabel.textColor = [UIColor colorWithRed:75.0/255 green:75.0/255 blue:75.0/255 alpha:1];
